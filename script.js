...
console.table(`Inventors born in the 1500's:`, fifteen);

// Array.prototype.map()
// 2. Give us an array of the inventors first and last names
const fullnames = inventors.map(inventor => `${inventor.first} ${inventor.last}`);

console.table(`Inventors full names:`, fullnames);

// Array.prototype.sort()
// 3. Sort the inventors by birthdate, oldest to youngest
const oldest = inventors.sort((a, b) => a.year > b.year ? 1 : -1);
console.table(`Inventors sorted by birthdate (oldest to youngest):`, oldest);
...
console.table(`Inventors sorted by years lived (oldest to youngest):`, oldestInventor);
...
// const parisBoulevards = boulevards
...
console.table(`People sorted by last name:`, sortedPeople);
